...
$(document).ready(function () {
    ...
    $(document).on("click", "#themBtn", function (e){
        ...
        $.ajax({
            ...
            dataType: 'json',
            data: jQuery("#themloaihanghoa_form").serialize(),
            success: function (data) {
                $("#type_table").DataTable().ajax.reload();
                $("#themloaihanghoa").removeClass("in");
                $(".modal-backdrop").remove();
                $("#themloaihanghoa").hide();
                toastr["success"]("Đã thêm " + $("#loaihanghoa").val(), "Thông báo");
            },
            error: function () {
                $("#themloaihanghoa").removeClass("in");
                $(".modal-backdrop").remove();
